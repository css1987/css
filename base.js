...
//fav
function fav() {
    URL = 'http://www.yssm.org'; title = '幼狮书盟';
    try {
...
if(jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')){
  document.write('欢迎您！ '+jieqiUserName+'&nbsp;&nbsp;<a href="/bookcase.php" target="_top">我的书架</a>');
...
var ReadSet = {
	...
	LoadCSS : function(){
			var style = "";
			style +=".readSet{padding:3px;clear:both;line-height:20px;width:800px;margin:auto;}\n";
